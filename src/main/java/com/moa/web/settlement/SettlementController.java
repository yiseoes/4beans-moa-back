...
public class SettlementController {
    ...
    public ResponseEntity<ApiResponse<List<SettlementResponse>>> getSettlements(
        ...
        List<SettlementResponse> settlements = settlementService.getSettlementHistory(userId, startDate, endDate);
    ...
    public ResponseEntity<ApiResponse<List<PaymentResponse>>> getSettlementDetails(
            @PathVariable Integer settlementId) {
        
        log.info("[API] 정산 상세 조회 - settlementId: {}", settlementId);
        
        List<PaymentResponse> payments = settlementService.getSettlementDetails(settlementId);
